<?php /* Template Name: Health Assessment Quiz */?>
<html>
   <head>
                  ...
                  <form action="" method="post">
                     <div class="assessment-section">
                        ...
                        <?php
                         ...
                         $ind = $key+1;
                         ?>
                      <input id="result<?=$ind?>" type="hidden" name="result" value="<?php echo $result['output']; ?>">
                      <?php
                         }
                         ?>
                                 ...
                                 <div data-question="3" class="question-item display">
                                    ...
                                    <div class="form-row">
                                       <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="question3<?=$index;?>">
                                          <?= $field['answer_option']; ?>
                                          </label>
                                       </div>
                                    </div>
                                 ...
                                 <div data-question="4" class="question-item">
                                    ...
                                    <div class="form-row">
                                       <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="question4<?=$index;?>">
                                          <?= $field['answer_option']; ?>
                                          </label>
                                       </div>
                                    </div>
                                 ...
                                 <div data-question="5" class="question-item display">
                                    ...
                                    <div class="form-row">
                                       <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="question5<?=$index;?>">
                                          <?= $field['answer_option']; ?>
                                          </label>
                                       </div>
                                    </div>
                                 ...
                                 <div data-question="6" class="question-item">
                                    ...
                                    <div class="form-row">
                                       <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="question6<?=$index;?>">
                                          <?= $field['answer_option']; ?>
                                          </label>
                                       </div>
                                    </div>
                                 ...
                                 <div data-question="7" class="question-item">
                                    ...
                                    <div class="form-row">
                                       <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="question7<?=$index;?>">
                                          <?= $field['answer_option']; ?>
                                          </label>
                                       </div>
                                    </div>
                                 ...
                                 <div data-question="8" class="question-item">
                                    ...
                                    <div class="form-row">
                                       <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="question8<?=$index;?>">
                                          <?= $field['answer_option']; ?>
                                          </label>
                                       </div>
                                    </div>
                        ...
                        <div id="questionnaire_3" class="questionnaire-section section-three">
                           <?php
                           ...
                           <div class="question-wrapper">
                              ...
                              <div class="symptoms_list">
                                 ...
                                 <div class="symptom-item symptom-group" data-group="<?= sanitize_title($symptom['symptom_title']); ?>">
                                    <div class="symptom-title">
                                       <?php echo $symptom['symptom_title'];?>
                                    </div>
                                    <?php
                                 ...
                                 <?php } ?>
                                 <input id="symptoms-questions" type="hidden" name="symptoms-questions" value="<?php echo $symptom_questions; ?>">
                                 <div class="symptoms-output">
                                    <div class="output-title">Symptom Output</div>
                                    <?php
                                        $index = 4;
                                       foreach($symptoms_list as $symptom) {
                                        $index++;
                                       ?>
                                    <div class="symptom-result-list" id="<?=sanitize_title($symptom['symptom_title']);?>">
                                       <?php echo $symptom['symptom_title'];?>: <span><?=$results[$index]['output'];?></span>
                                    </div>
                                    <?php } ?>
                                 </div>
                              </div>
                              <div class="questionnaire-actions">
                                  <div class="middle-actions">
                                     ...
                                     <button data-progress="78" data-next-tab="4" class="btn-hide btn btn--lg btn--orange questionnaire-next has-result-next-tab">Continue</button>
                                  </div>
                               </div>
                           </div>
                        </div>
                                ...
                                <div data-question="3" class="question-item display">
                                  ...
                                  <div class="form-row">
                                     <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="question9<?=$index;?>">
                                        <?= $field['answer_option']; ?>
                                        </label>
                                     </div>
                                  </div>
                                   ...
                                   <div data-question="3" class="question-item display">
                                     ...
                                     <div class="form-row">
                                        <div class="form-check">
                                           ...
                                           <label class="form-check-label" for="question10<?=$index;?>">
                                           <?= $field['answer_option']; ?>
                                           </label>
                                        </div>
                                     </div>
                                ...
                                <div class="form-row">
                                 ...
                                 <div class="form-row">
                                     <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="receive-menopause">
                                            I wish to opt-in to receive free menopause resources
                                        </label>
                                     </div>
                                  </div>
                                  ...
                                  <div class="form-row">
                                   <div class="form-check">
                                      ...
                                      <label class="form-check-label" for="contacted-phone">
                                          I would like to be contacted by phone from AMC
                                      </label>
                                   </div>
                                </div>
                                <div class="questionnaire-actions">
      ...
      <script>
         window.addEventListener("load",function(event) {
             $(document).ready(function() {
                 ...
                 // Handle next button
                 $('.questionnaire-continue, .has-result-next-tab').on('click', function(e) {
                      e.preventDefault();
